...
namespace client.Main.Clothes
{
    ...
    {
        public UIMenu Menu;
        public UIMenuSliderItem MaleModels;
        public UIMenuSliderItem FemaleModels;

        private List<string> modelMaleList = new List<string>()
        {
            "mp_m_freemode_01",
            "player_zero",
            "player_one",
            ...
            "csb_chef",
            "csb_chin_goon",
            "csb_cletus", "csb_customer", "csb_fos_rep", "csb_g", "csb_groom", "csb_grove_str_dlr", "csb_hao", "csb_hugh", "csb_imran", "csb_janitor", "csb_ortega", "csb_oscar", "csb_porndudes", "csb_prologuedriver", "csb_ramp_gang",  "csb_ramp_hic", "csb_ramp_hipster", "csb_ramp_mex", "csb_reporter", "csb_roccopelosi", "csb_trafficwarden",
            "cs_bankman", "cs_barry", "cs_beverly", "cs_brad", "cs_carbuyer", "cs_chengsr", "cs_chrisformage", "cs_clay", "cs_dale", "cs_davenorton", "cs_devin", "cs_dom", "cs_dreyfuss", "cs_drfriedlander", "cs_fabien", "cs_floyd", "cs_hunter", "cs_jimmyboston", "cs_jimmydisanto", "cs_joeminuteman", "cs_johnnyklebitz", "cs_josef", "cs_josh", "cs_lazlow", "cs_lestercrest", "cs_lifeinvad_01", "cs_manuel", "cs_martinmadrazo", "cs_milton", "cs_movpremmale", "cs_mrk", "cs_nervousron", "cs_nigel", "cs_old_man1a", "cs_old_man2", "cs_omega", "cs_orleans", "cs_paper", "cs_priest", "cs_prolsec_02", "cs_russiandrunk", "cs_siemonyetarian", "cs_solomon", "cs_stevehains", "cs_stretch", "cs_taocheng", "cs_taostranslator", "cs_tenniscoach", "cs_terry", "cs_tom", "cs_tomepsilon", "cs_wade", "cs_zimbor", "g_m_m_armboss_01",
            "g_m_m_armgoon_01",
            "g_m_m_armlieut_01",
            "g_m_m_chemwork_01",
            "g_m_m_chiboss_01",
            ...
            "g_m_y_strpunk_01",
            "g_m_y_strpunk_02",
            "hc_driver", "hc_gunman", "hc_hacker", "s_m_m_ammucountry",
            "s_m_m_autoshop_01",
            "s_m_m_autoshop_02",
            "s_m_m_bouncer_01",
            "s_m_m_ciasec_01",
        ...
        private List<string> modelFemaleList = new List<string>()
        {
            "mp_f_freemode_01",
            "ig_tracydisanto",
"a_f_m_beach_01",
